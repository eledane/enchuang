	...
	function print_options() {
        ...
        <tr valign="top">
		 ...
		 <tr valign="top">
			...
			<br>Slideshow interval (ms): <input name="slideinterval" type="number" min=0 id="slideinterval" value="<?php echo esc_html($lightbox_options['slideinterval']); ?>" class="small-text" />
		...
		<tr valign="top">
			<th scope="row">Close the lightbox when clicking the overlay background</th>
			<td><label for="closeonoverlay"><input name="closeonoverlay" type="checkbox" id="closeonoverlay" value="1" <?php echo $lightbox_options['closeonoverlay'] ? "checked": ""; ?> /> Close the lightbox when clicking on the overlay background</label></td>
		</tr>
		...
		<tr valign="top">
			...
			Opacity: <input name="overlayopacity" type="number" min=0 max=1 step="0.1" id="overlayopacity" value="<?php echo esc_html($lightbox_options['overlayopacity']); ?>" class="small-text" /></td>
		</tr>
		...
		<tr valign="top">
			...
			<td>Radius (px): <input name="borderradius" type="number" min=0 id="borderradius" value="<?php echo esc_html($lightbox_options['borderradius']); ?>" class="small-text" />
			Size (px): <input name="bordersize" type="number" min=0 id="bordersize" value="<?php echo esc_html($lightbox_options['bordersize']); ?>" class="small-text" />
			</td>
		</tr>
